...
describe('Testando o endpoint /api/clients', () => {
    ...
    expect(response.body).toHaveProperty('message', 'Client created successfully'); // Verifica se a mensagem de sucesso é retornada
    });
    ...
    test('Deve atualizar um cliente quando enviado um PATCH válido', async () => {
        ...
        expect(response.body).toHaveProperty('message', 'Client updated successfully'); // Verifica se a mensagem de sucesso é retornada
    });
