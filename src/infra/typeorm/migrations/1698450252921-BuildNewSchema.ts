...
export class BuildNewSchema1698450252921 implements MigrationInterface {
    name = 'BuildNewSchema1698450252921'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "Orders_Products" ("id" integer GENERATED BY DEFAULT AS IDENTITY NOT NULL, "productId" uuid, "orderId" uuid, CONSTRAINT "PK_ded71cf7e8ebd4c628c673985b2" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."Orders_status_enum" AS ENUM('RECEBIDO', 'EM_PREPARACAO', 'PRONTO', 'FINALIZADO')`);
        await queryRunner.query(`CREATE TABLE "Orders" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "status" "public"."Orders_status_enum" NOT NULL DEFAULT 'RECEBIDO', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "clientId" uuid, CONSTRAINT "PK_ce8e3c4d56e47ff9c8189c26213" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "Orders_Products" ADD CONSTRAINT "FK_0aa8b716b82b13e006670f9eb1c" FOREIGN KEY ("orderId") REFERENCES "Orders"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
