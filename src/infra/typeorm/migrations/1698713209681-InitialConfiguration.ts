...
export class InitialConfiguration1698713209681 implements MigrationInterface {
    name = 'InitialConfiguration1698713209681'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "Orders" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "status" "public"."Orders_status_enum" NOT NULL DEFAULT 'AGUARDANDO_PAGAMENTO', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "clientId" uuid, CONSTRAINT "PK_ce8e3c4d56e47ff9c8189c26213" PRIMARY KEY ("id"))`);
